...
Para configurar `Burpsuite` utilizando `FireFox` y `Foxy Proxy` ya sea en Linux o Windows e interceptar tráfico HTTP/HTTPS desde cualquier explorador solo se deben seguir 3 sencillos pasos:
